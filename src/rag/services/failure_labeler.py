...
from rag.config import FAILURE_LABELS_PATH, EVALUATION_DATASET_PATH, BASELINE_RESULTS_PATH, HYBRID_RESULTS_PATH

logger = logging.getLogger(__name__)

_LABELS_FILE = FAILURE_LABELS_PATH
_DATASET_FILE = EVALUATION_DATASET_PATH
